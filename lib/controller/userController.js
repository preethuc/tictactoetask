  ...
  try {
    ...
    if (doc.length == 0) {
      ...
      if (updation.acknowledged) {
        ...
        //----------------------chances to be win----------------------
        //1st-row
        if (_user[0].X_O_position[0][0] == _user[0].X_O_position[0][1] == _user[0].X_O_position[0][2]) {
          win = true;
          return res.json({ success: "true", Win: _user[0].last_user[0] });
        }
        //2nd-row
        if (_user[0].X_O_position[1][0] == _user[0].X_O_position[1][1] == _user[0].X_O_position[1][2]) {
          win = true;
          return res.json({ success: "true", Win: _user[0].last_user[0] });
        }
        //3rd-row
        if (_user[0].X_O_position[2][0] == _user[0].X_O_position[2][1] == _user[0].X_O_position[2][2]) {
          win = true;
          return res.json({ success: "true", Win: _user[0].last_user[0] });
        }
        //1st-column
        if (_user[0].X_O_position[0][0] == _user[0].X_O_position[1][0] == _user[0].X_O_position[2][0]) {
          win = true;
          return res.json({ success: "true", Win: _user[0].last_user[0] });
        }
        //2nd-column
        if (_user[0].X_O_position[0][1] == _user[0].X_O_position[1][1] == _user[0].X_O_position[2][1]) {
          win = true;
          return res.json({ success: "true", Win: _user[0].last_user[0] });
        }
        //3rd-column
        if (_user[0].X_O_position[0][2] == _user[0].X_O_position[1][2] == _user[0].X_O_position[2][2]) {
          win = true;
          return res.json({ success: "true", Win: _user[0].last_user[0] });
        }
        //first-cross
        if (_user[0].X_O_position[0][0] == _user[0].X_O_position[1][1] == _user[0].X_O_position[2][2]) {
          win = true;
          return res.json({ success: "true", Win: _user[0].last_user[0] });
        }
        //last-cross
        if (_user[0].X_O_position[0][2] == _user[0].X_O_position[1][1] == _user[0].X_O_position[2][0]) {
          win = true;
          return res.json({ success: "true", Win: _user[0].last_user[0] });
        }
